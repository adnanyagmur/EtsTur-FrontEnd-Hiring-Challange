...
function HomePage() {
  ...
  //filtreleme
  const [filterString, setFilterString] = useState([eventList]);
  ...
  const filtered = (filteredData)=>{
    ...
    const filteredSehir = filteredData.filter(
      (sehir)=> sehir.name.split(" ").indexOf(selectedSehir) !==-1
    );
    return filteredSehir
              ...
              {filtered.map((eventList, key) =>
                ...
                <EventList
                  ...
                  description={eventList?.content?.replace("<br /><br />", " ").replace("<br /><br />", " ").replace("</strong>", " ").replace("<br />", " ")
                    ...
                    .replace("<br />", " ").replace("<br /><br />", " ").replace("<br /><br />", " ").replace("</strong>", " ").replace("<br />", " ")
                    .replace("<strong>", " ").replace("<br /><strong>", " ")
                    .replace("</strong><br />", " ")
                    .replace("</p>", " ").replace("<p>", " ").replace("<p>", " ")
                    .replace("</p>", " ").replace("<br /><br />", " ").replace("<br /><br />", " ").replace("</strong>", " ").replace("<br />", " ")
