            ...
            <SimpleGrid columns={[1, null, 2, 3, 4, 5]} spacing='40px'>
              ...
              {eventList.items?.map((eventList, key) =>
                ...
                <EventList
                  ...
                  description={eventList?.content?.replace("<table border=0 cellspacing=0 cellpadding=0 width=749>,<tbody>,<tr>,<td width=749 valign=top>"," ").replace("<br /><br />", " ").replace("<br /><br />", " ").replace("</strong>", " ").replace("<br />", " ")
