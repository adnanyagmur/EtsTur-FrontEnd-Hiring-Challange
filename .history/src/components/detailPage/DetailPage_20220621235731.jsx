...
import { Grid, Image, Box, GridItem, Text, SimpleGrid, Button, background} from '@chakra-ui/react';
                ...
                <GridItem pt='4' pr='6' bg='white' area={'main'} >
                    ...
                    <SimpleGrid columns={[null, 1]} spacing='40px'>
                        ...
                        <Grid
                            ...
                            bg="purple.500"
                        >
                            <GridItem pl="2" pr="2" pt="2" rowSpan={2} colSpan={1} bg='white' >
                            <Text >  {name}</Text>
                                <Text>  {category}</Text>
                                <Text>  {price}</Text>
                            ...
                            <GridItem pl="7"  colSpan={2} bg='white' ><br></br>
