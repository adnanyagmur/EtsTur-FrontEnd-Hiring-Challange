...
import { Grid,İmage, Box, GridItem, Text, SimpleGrid, Input, InputGroup, Button, InputRightElement } from '@chakra-ui/react';
        ...
        >
          ...
          <GridItem pl='6' pt='4' pr='6' bg='white' area={'main'} >
            ...
            <SimpleGrid columns={[1, null, 2, 3, 4, 5]} spacing='40px'>
              ...
              +  {image} + {category} + {description} + {price} + {basTarih}  +{bitistarihi}
