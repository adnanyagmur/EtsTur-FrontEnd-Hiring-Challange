...
>
  ...
  <InputGroup  w={breakpoints} as='span'  size='md'>
      ...
      <InputRightElement  w={breakpoints}>
        <Button  w={breakpoints} bg='purple.600' mr='2' h='1.75rem' size='sm' /* onClick={handleClick} */>
       <Text w={breakpoints}>   Filtrele </Text>  
        </Button>
      </InputRightElement>
    </InputGroup>
    <Button  w={breakpoints} bg='purple.600' mr='2' h='1.75rem' size='sm' mt="2" border='2px' borderColor='white' onClick={handleClick} >
          <Text w={breakpoints}>   Gelecek Etkinlikler </Text>  
        </Button>
</SimpleGrid>
